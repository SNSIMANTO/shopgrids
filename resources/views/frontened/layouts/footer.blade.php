            ...
            <div class="row">
               <div class="col-lg-3 col-md-4 col-12">
                  <div class="footer-logo">
                     <a href="index.html">
                     <img src="frontened/images/logo/white-logo.svg" alt="#">
                     </a>
                  </div>
               </div>
            ...
            <div class="row align-items-center">
               <div class="col-lg-4 col-12">
                  <div class="payment-gateway">
                     <span>We Accept:</span>
                     <img src="frontened/images/footer/credit-cards-footer.png" alt="#">
                  </div>
               </div>
               <div class="col-lg-4 col-12">
                  <div class="copyright">
...
<script src="{{ asset('frontened') }}/js/tiny-slider.js"></script>
<script src="{{ asset('frontened') }}/js/glightbox.min.js"></script>
