...
<body>
  ...
  <!-- JS Libraies -->
  <script src="backend/modules/jquery-pwstrength/jquery.pwstrength.min.js"></script>
  <script src="backend/modules/jquery-selectric/jquery.selectric.min.js"></script>
